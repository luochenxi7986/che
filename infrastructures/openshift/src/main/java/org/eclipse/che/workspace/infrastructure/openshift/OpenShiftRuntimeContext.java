...
import org.eclipse.che.workspace.infrastructure.openshift.project.OpenShiftNamespaceFactory;
...
public class OpenShiftRuntimeContext extends RuntimeContext {
  ...
  private final OpenShiftNamespaceFactory namespaceFactory;
  ...
  public OpenShiftRuntimeContext(
      ...
      OpenShiftNamespaceFactory namespaceFactory,
  ...
  public InternalRuntime getRuntime() throws InfrastructureException {
    ...
    if (projectName != null) {
      return runtimeFactory.create(this, namespaceFactory.createNamespace(projectName, wsId));
    }
    return runtimeFactory.create(this, namespaceFactory.createNamespace(wsId));
  }
}
